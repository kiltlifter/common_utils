...
class UnitConversion:
    ...
    def _convert_bytes(self, x_bytes):
        """
    ...
    def _convert_string(self, value, unit):
        """
    ...
    @classmethod
    def bytes_to_str(cls, x_bytes, binary=True, precision=2):
        """
    ...
    @classmethod
    def str_to_bytes(cls, value, binary=True):
        """
